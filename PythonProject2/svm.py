...
if uploaded_file is not None:
    ...
    st.write("SVM Train R²:", r2_score(y_train, svm_model.predict(X_train_scaled_svm)))
    st.write("SVM Test R²:", r2_score(y_test, svm_model.predict(X_test_scaled_svm)))
    ...
    history = nn_model.fit(X_train_scaled_nn, y_train,
    ...
    nn_pred_train = nn_model.predict(X_train_scaled_nn)
    nn_pred_test = nn_model.predict(X_test_scaled_nn)
